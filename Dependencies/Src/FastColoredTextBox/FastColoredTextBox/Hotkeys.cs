...
namespace FastColoredTextBoxNS
{
    ...
    public class HotkeysMapping : SortedDictionary<KEYS, FCTBAction>
    {
        ...
        public override string ToString()
        {
            ...
            {
                _ = sb.AppendFormat("{0}={1}, ", kc.ConvertToString(null, CultureInfo.InvariantCulture, pair.Key), pair.Value);
            }
        ...
        public static HotkeysMapping Parse(string s)
        {
            ...
            {
                var pp = p.Split('=');
                var k = (KEYS)kc.ConvertFromString(null, CultureInfo.InvariantCulture, pp[0].Trim());
