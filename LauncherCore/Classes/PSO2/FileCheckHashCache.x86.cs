...
{
    public class FileCheckHashCacheX86 : IFileCheckHashCache
    {
        ...
        public FileCheckHashCacheX86(string filepath, in int concurrentLevel)
        {
            this.state = 0;
            this.buffering = null;
        ...
        public bool TryGetPatchItem(string filename, out PatchRecordItemValue item)
        {
            switch (Interlocked.CompareExchange(ref this.state, -1, -1))
            {
                ...
                case 2:
                    throw new ObjectDisposedException(nameof(FileCheckHashCacheX86));
                default:
