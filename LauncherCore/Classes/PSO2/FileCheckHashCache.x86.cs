...
{
    partial class FileCheckHashCache
    {
        sealed class FileCheckHashCacheX86 : FileCheckHashCache
        {
            private readonly SQLiteConnection sqlConn;

            public FileCheckHashCacheX86(string filepath, in int concurrentLevel) : base(in concurrentLevel)
            {
